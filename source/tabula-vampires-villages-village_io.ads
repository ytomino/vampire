...
package Tabula.Vampires.Villages.Village_IO is
	...
	package Execution_IO is new DYAYaml.IO_Enumeration (Execution_Mode);
	...
	package Monster_Side_IO is new DYAYaml.IO_Enumeration (Monster_Side_Mode);
	package Teaming_IO is new DYAYaml.IO_Enumeration (Teaming_Mode);
